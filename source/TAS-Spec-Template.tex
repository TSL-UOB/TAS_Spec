...
The preceding section discussed specification challenges that are unique to a representative set of domains investigated within our community. Now we discuss several ``intellectual challenges'' that are involved with specifying for trustworthiness in AS that can cut across domains, and are exacerbated by the inherent uncertainty involved with the environments in which AS need to operate. 
...
Meanwhile, the remaining four challenges have either a \emph{common} focus (7) across the programme, or they are \emph{emerging} in nature (8--10) (see Fig.~\ref{Intellectual-challenges}). %as identified during the breakout sessions. %challenges were identified during the breakout sessions. 
...
%% This approach may allow conflicts between properties to be more easily resolved.	
	...
	\vspace{-3.6pt}
	\begin{acks}
		This work has been supported by the UK Engineering and Physical Sciences Research Council (EPSRC) under the grants: [EP/V026518/1], [EP/V026607/1], [EP/V026747/1], [EP/V026763/1], [EP/V026682/1], [EP/V026801/2] and [EP/S027238/1]. Y.D. is also supported by a RAEng Chair in Emerging Technologies [CiET1718\textbackslash46].
	\end{acks}
