...
%	Also, we intentionally leave the discussion on the formalisation of these specifications for the future, when understanding of what is required to specify for trustworthiness is more mature.
	...
	Thus, in this context, we take a broad view of specification, concentrating on top-level requirements including but not limited to functionality, safety, security and other non-functional properties that contribute to trustworthiness of AS. 
	Also, we intentionally leave the discussion on the formalisation of these specifications for the future, when understanding of what is required to specify for trustworthiness is more mature.

	% New content - Dhaminda 2022/11/25	
	...
	Undertaking a community approach, this roadmap paper is a result of a workshop, which gathered a diverse group of high-quality researchers from all the Nodes and the Hub in September 2021. 
...
\begin{table}
	\caption{AS domains and their specification challenges.} \label{AS-challenges}   
	\vspace{-4mm}
	\begin{tabular}[width=0.4\textwidth]{ |p{1.22cm}||p{1.2cm}|p{6cm}| } 
		\hline
		\textbf{Class} & \textbf{Domain} & \textbf{Specification Challenge/s} \\
		\hline
