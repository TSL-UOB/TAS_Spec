...
In this section, we identify key challenges for specifying for trustworthiness in AS and illustrate these challenges using examples from key research domains currently being investigated within the research community. For each research question, termed \emph{intellectual challenge}, we provide an overview, identify high-priority challenges, and suggest future directions.
